...
Customer Management| Add Customer| Add new customer details to the system
Customer Management| View Customer| Display all customer records
Customer Management| Update Customer| Edit existing customer information
Customer Management| Delete Customer| Remove customer records
...
id| INT (Primary Key)| Unique identification number for each customer
name| VARCHAR(100)| Customer full name
phone| VARCHAR(20)| Customer contact number
room_no| VARCHAR(20)| Allocated hotel room number
...
Delete| Delete Customer| Remove unwanted records

---

🖥️ Application Interface Components

Component| Purpose
Header Section| Displays system title and hotel identity
Input Form| Enter customer information
Buttons| Perform system operations
Data Table| Display customer records
Database| Store permanent information
...
main.py| Contains GUI design and application logic
